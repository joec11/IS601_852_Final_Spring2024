...
from app.schemas.user_schemas import UserBase, UserCreate, UserUpdate, UpdateOwnUserProfile, UserResponse, UserListResponse, LoginRequest
...
# Test a user to update their own profile information with valid data
def test_update_own_user_profile_information_with_valid_data(user_base_data):
    update_user_profile = UpdateOwnUserProfile(**user_base_data)
...
# Test a user to update their own profile information with invalid data
def test_update_own_user_profile_information_with_invalid_data(user_base_data):
    user_base_data["email"] = ""
    with pytest.raises(ValidationError):
        UpdateOwnUserProfile(**user_base_data)
